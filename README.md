...
Inhere, Ihave used VS Code, Docker, AWS Console, Terraform, GitLab
...
##   This readme is generated via GitLab platform 
## Getting started
...
```
cd existing_repo
git remote add origin https://gitlab.com/kalaniganganee98-group/flask-app.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/kalaniganganee98-group/flask-app/-/settings/integrations)
